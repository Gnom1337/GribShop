...
<body>
    <header id="shop">
        ...
        <main>
          <h2 style="text-align:center; margin-top:15px; margin-bottom:20px;">Комплектующие</h2>
          ...
          // Ругаемся, если соединение установить не удалось
            ...
            <button  class="btn btn-primary btn-ens-action item add-item add-to-cart" data-rel="'.$result['id'].'">'.$result['Цена'].' ₽ </br>Добавить в корзину </button>
            </div>
            </div>';
            }
            ?>
